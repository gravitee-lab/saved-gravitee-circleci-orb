...
export MVN_PRJ_VERSION=$(mvn -Dexec.executable='echo' -Dexec.args='${project.version}' --non-recursive exec:exec -q)
...
echo "trimmed from-SNAPSHOT Maven Project version : [${MVN_PRJ_VERSION}]"
